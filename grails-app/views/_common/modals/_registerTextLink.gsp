...
<%--
<button href="#RegisterModal" class="btn btn-large btn-primary" role="button" data-toggle="modal" title="${message(code: 'security.register.label', default: 'Register')}">
	<i class="glyphicon glyphicon-signin"></i> 
	<g:message code="security.register.label"/>
</button>

--%>
<a href="/register" class="btn btn-large btn-primary" role="button"><i class="glyphicon glyphicon-signin"></i> 
	<g:message code="security.register.label"/></a>
